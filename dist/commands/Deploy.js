import { assertDependencies, assertGCloudAuth, provisionApplicationInfrastructure, provisionBaselineInfrastructure, } from "../utils/helpers.js";
import Spinner from "../utils/spinner.js";
import Command from "./AbstractCommand.js";
class Deploy extends Command {
    constructor() {
        super("deploy", "Deploys symphony infrastructure", [["<domain>", "domain name"]], []);
    }
    async action(...args) {
